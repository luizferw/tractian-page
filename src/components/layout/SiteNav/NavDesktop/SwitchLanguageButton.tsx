  ...
  return (
    ...
    >
          ...
          <div className="absolute left-0 top-10 z-[1000] flex w-full flex-col items-center rounded-[2px] border border-slate-300 bg-slate-50 p-2 text-slate-500 transition-opacity duration-default ease-in-out text-body-sm lg:left-3 lg:top-8 lg:w-auto lg:border-2 xl:text-body-md">
            {availableLocales.map((localeItem) => (
              <Button
                ...
                className="justify-start hover:text-slate-500 flex w-full items-center gap-x-2 rounded-[2px] !px-3 py-2 text-body-md !hover:bg-slate-100 lg:py-2 lg:text-body-sm data-[active=true]:bg-slate-200 data-[active=true]:hover:bg-slate-200"
              >
                <p
      ...
      <Button
        ...
        size="sm"
        className="group flex w-full items-center justify-between gap-x-2 rounded-[2px] px-4 !py-1 text-body-sm focus:outline-none lg:bg-transparent lg:bg-opacity-20 lg:px-2 lg:text-slate-50 xl:pl-3 xl:text-body-md"
      >
